...
import { ContentBox, CustomButton, ImageBox, ProfileImgInput } from '../components/StyledComponents/CommonStyle';
...
const MyProfile = () => {
  ...
  const handleProfileUpdate = (field: string, e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    dispatch(
      setUserData({
        ...user,
                  ...
                  (
                    <Box>
                      <Grid container justifyContent={'space-between'} alignItems={'center'} my={2}>
                        <Typography variant="body1" color={primaryColor}>Name</Typography>
                        <Typography variant="body1" color={secondaryColor} className='profileData'>{user.first_name + " " + user.last_name}</Typography>
                      </Grid>
                      <Grid container justifyContent={'space-between'} alignItems={'center'} my={2}>
                        <Typography variant="body1" color={primaryColor}>Email</Typography>
                        <Typography variant="body1" color={secondaryColor} className='profileData'>{user.email}</Typography>
                      </Grid>
                    </Box>
                  )
              }
